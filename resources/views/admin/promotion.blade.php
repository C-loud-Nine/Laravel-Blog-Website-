...
<head>
    ...
    <style type="text/css">
        ...
        .remove-btn {
            ...
            background-color: green; /* Change button background color to red */
...
<body>
    ...
    <div class="d-flex align-items-stretch">
        ...
        <h1 class="title_deg">Eligible Blogger List</h1>
            <table class="table_deg">
                ...
                <tbody>
                    ...
                    <tr class="td_deg">
                        ...
                        <td class="td_deg">
                            <a href="{{url('add_promotion',$blogger->id)}}" class="btn btn-success" onclick="return confirm('Would You Like to Proceed ?')">Promote</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
